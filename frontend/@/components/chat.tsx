	...
	return (
		<div key="1" className="bg-[#1E1E2D] h-screen flex flex-col">
			...
			<section className="flex-grow flex flex-col flex-1 p-6">
				{/* <header className="flex-shrink flex flex-initial justify-between items-center mb-6">
					<h2 className="text-white text-xl font-semibold">
						Chat with Russel Hue
					</h2>
				...
				<ScrollArea className="flex-grow mb-6">
					<div className="space-y-4">
						...
						<div className="float-left flex items-center">
							...
							<div className="bg-[#353945] text-white rounded-lg p-3 max-w-xs ml-2">
